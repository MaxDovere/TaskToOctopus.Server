...
{
    [Table("T_Sequence_Action")]
    public partial class T_Sequence_Action
    {
        [Key]
        [StringLength(59)]
        ...
        [InverseProperty(nameof(T_Sequence.T_Sequence_Actions))]
        public virtual T_Sequence Sequence { get; set; }
    }
}
